...
public class CompanyDAOImp implements CompanyDAO {
    ...
    public Page<Company> getList() {
        ...
        return new Page<Company>(queryFactory.get().select(qCompany).from(qCompany).fetch());
    ...
    public Company getCompanyById(long id) {
        ...
        Company companyResult = queryFactory.get().select(qCompany).from(qCompany).where(qCompany.id.eq(id)).fetchOne();
    ...
    public Company getCompanyByName(String name) {
        ...
        Company companyResult = queryFactory.get().select(qCompany).from(qCompany).where(qCompany.name.like(name))
                .fetchOne();
    ...
    public Company delete(long id) {
        ...
        List<Computer> computersResult = queryFactory.get().select(qComputer).from(qComputer)
                .where(qComputer.company.id.eq(id)).fetch();
