...
public class ComputerDAOImp implements ComputerDAO {
    ...
    @Override
    public Page<Computer> getList(int page, int nbrElements) {
        ...
        return new Page<Computer>(computersResult, page, nbrElements);
    ...
    public Computer update(Computer computer) {
        LOGGER.trace("Computer.update is running");
    ...
    @Override
    public Page<Computer> getComputerByName(String name) {
        ...
        return new Page<Computer>(computersResult);
    }
